	...
	if(isset($_POST['submit2']))
	{
		if(!empty($_FILES['file1']))
			{	
				...
				$newfilename1 = $i . $file_ext1;
				$target_dir1 = "material/";
				...
				if (move_uploaded_file($_FILES["file1"]["tmp_name"], $target_file1)) 
				{
                    ...
                    if(mysqli_query($cn,"insert into course(username,file_name,article) values('$username','$newfilename1','$article')"))
                    {
                        $c=1;
                    }
							...
							<div class="row">
								<div class="col-md-3">
									<ul class="nav nav-pills nav-stacked admin-menu" >
										...
										<li><a href="" data-target-id="c_upload"><i class="glyphicon glyphicon-cog"></i> Upload</a></li>
								...
								<div class="col-md-9  admin-content" id="c_upload">
									<form action="" style="" method="POST" enctype="multipart/form-data">
                                        <div>
  										<input type="file" style="position: absolute;margin: 0;padding: 0;width: 100%;height: 37%;outline: none;opacity: 0;top: 0%;left: 0%;margin-top: 0px;margin-left: 0px;" name="file1" id="file1" multiple>
  										<p style="width: 100%;height: 30%;	text-align: center;line-height: 170px;color: #ffffff;font-family: Arial; border: 4px dashed #fff;">Drag your files here or click in this area.</p>
                                        </div>
                                        <h3 class="panel-title"><label for="f_name" class="control-label panel-title">Write Article</label></h3>
                                        <input style='text-transform: capitalize;' size='50' type='Addresh' rows='10' class='form-control' name='article' id='article' multiple>
										
											<br>
											<br>
											<button type="submit" class="form-control btn btn-primary" name="submit2" id="submit2">Upload</button>
