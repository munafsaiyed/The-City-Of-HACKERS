...
$rs=mysqli_query($cn,"select * from trackingg where id=$id") or die(mysqli_error($cn));
...
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBIJbYOa22OasGTnGGHi0X1B8lYq68O65I"></script>
<!-- Chart JS -->
