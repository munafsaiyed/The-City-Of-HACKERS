                    ...
                    <div class="col-md-12">
                        <div class="card" >
                            <div class="card-header">
                                <h4 class="card-title"> Course Uploaded</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        echo  "<tr>
                                                <td><img src='../material/",$row['file_name'];
                                           ...
                                           echo "</td>
                                                <td class='text-right'><a href='del_co.php?varname=";
                                                echo $row['cid']; echo "'><input type='submit' class='btn btn-primary btn-block' name='",$row['cid'];echo "'value='delete'>
                                                </a></td>
                                            </tr>";
                                        }
                                            ?>
