                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $rs=mysqli_query($cn,"select * from query_form") or die(mysqli_error($cn));
                                        ...
                                        echo  "<tr>
                                           ...
                                           echo "</p></td>
                                                <td class='text-right'><a href='del_que.php?varname="; echo $row['q_id']; echo "'><input type='submit' class='btn btn-primary btn-block' name=",$row['q_id']; echo "' value='Delete'></a>
                                                </td>
                                            </tr>";
                                        }
